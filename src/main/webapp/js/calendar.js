...
Calendar.language = {
	"year" : [ "\u5e74", "", "", "\u5e74" ],
	"months" : [ [ "\u4e00\u6708", "\u4e8c\u6708", "\u4e09\u6708", "\u56db\u6708", "\u4e94\u6708", "\u516d\u6708", "\u4e03\u6708", "\u516b\u6708", "\u4e5d\u6708", "\u5341\u6708", "\u5341\u4e00\u6708", "\u5341\u4e8c\u6708" ], [ "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" ], [ "JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" ],
			[ "\u4e00\u6708", "\u4e8c\u6708", "\u4e09\u6708", "\u56db\u6708", "\u4e94\u6708", "\u516d\u6708", "\u4e03\u6708", "\u516b\u6708", "\u4e5d\u6708", "\u5341\u6708", "\u5341\u4e00\u6708", "\u5341\u4e8c\u6708" ] ],
	"weeks" : [ [ "\u65e5", "\u4e00", "\u4e8c", "\u4e09", "\u56db", "\u4e94", "\u516d" ], [ "Sun", "Mon", "Tur", "Wed", "Thu", "Fri", "Sat" ], [ "Sun", "Mon", "Tur", "Wed", "Thu", "Fri", "Sat" ], [ "\u65e5", "\u4e00", "\u4e8c", "\u4e09", "\u56db", "\u4e94", "\u516d" ] ],
...
Calendar.prototype.show = function(dateControl, popuControl) {
	...
	this.panel.style.left = (xy.x + dateControl.offsetWidth - this.panel.offsetWidth) + "px";
...
function addDays(current, days) {
	var date = new Date(Date.parse(current.replace(/-/g, "/")));
	date.setDate(date.getDate() + days);
	return date.format("yyyy-MM-dd");
};

function addMonths(current, months) {
	var date = new Date(Date.parse(current.replace(/-/g, "/")));
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:260px;height:260px;">');
...
__ci.document.writeln('body {font-size:13px;margin:0px;text-align:center;}');
__ci.document.writeln('form {margin:0px;}');
__ci.document.writeln('select {font-size:13px;background-color:#EFEFEF;}');
__ci.document.writeln('table {border:0px solid #CCCCCC;background-color:#FFFFFF}');
__ci.document.writeln('th {font-size:13px;font-weight:normal;background-color:#FFFFFF;}');
__ci.document.writeln('th.theader {font-weight:normal;background-color:#666666;color:#FFFFFF;width:24px;height:20px;}');
__ci.document.writeln('select.year {width:80px;height:25px;font-size:13px;font-family:华文细黑;}');
__ci.document.writeln('select.month {width:70px;height:25px;font-size:13px;font-family:华文细黑;}');
__ci.document.writeln('td {font-size:13px;text-align:center;}');
...
__ci.document.writeln('td.normal {background-color:#EFEFEF;font-size:13px;font-family:华文细黑;height:20px;}');
__ci.document.writeln('input.l {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:25px;}');
__ci.document.writeln('input.r {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:25px;}');
__ci.document.writeln('input.b {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:100%;height:30px;font-size:14px;font-family:华文细黑;}');
__ci.document.writeln('-->');
