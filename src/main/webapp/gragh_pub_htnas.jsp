...
<body>
	<div class="title-div">
		...
		<span class="label-text">时间起</span>
		<input class="cal-editor" type="text" id="pro_date_begin" maxlength="10"
				onclick="new Calendar().show(this);" onchange="check_obtain();" readonly="readonly">
		<span class="label-text">时间止</span>
		<input class="cal-editor" type="text" id="pro_date_end" maxlength="10"
				onclick="new Calendar().show(this);" onchange="check_obtain();" readonly="readonly">
	</div>
</body>
</html>